        ...
        mt-[50px] md:mt-[229px]'>
            ...
            <Link href={`/products/id?cardImage=${Category2.categoriesTwoImage1}&heading=Compact Orange Plastic Chair&newPrice=120`}>
              <div className='relative group'>
                ...
                <div className='w-full hover:flex items-center justify-between bg-black 
                text-[14px] md:text-[30px] text-white 
                p-[10px] md:p-[20px] absolute bottom-[0px] hidden group-hover:flex'>
                      <p>Sofa Chairs</p>
                      <p>200 Products</p>
                </div>
              </div>
            ...
            gap-[10px] md:gap-[24px] '>
                ...
                <Link href={`/products/id?cardImage=${Category2.categoriesTwoImage2}&heading=White Cream Sofa Chair&newPrice=50`}>
                    ...
                    <div className='w-full hover:flex items-center justify-between bg-black text-[10px] md:text-[20px] text-white p-[5px] md:p-[10px] absolute bottom-[0px] hidden group-hover:flex'>
                      <p>Sofa Chairs</p>
                      <p>200 Products</p>
                    </div>
                    </div>
